...
<title>Toko Pixel Perfect</title>
<body>
    <nav class="navbar navbar-dark bg-dark">
            <span class="navbar-brand mb-0 h1">AGITYA PUTRA</span>
        </div>
    </nav>
<div class="container">
    <br>
...
<?php
    ...
    if (isset($_GET['id_barang'])) {
        ...
        $sql="delete from tbl_agitstok where id_barang='$id_barang' ";
...
?>
     ...
     <tr class="table-danger">
       ...
       <table class="my-3 table table-bordered">
        ...
        $sql="select * from tbl_agitstok order by id_barang desc";
